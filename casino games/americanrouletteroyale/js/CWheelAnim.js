function CWheelAnim(iX,iY){
	...
	var oFade = new createjs.Shape();
        ...
        _oResultText = new CTLText(_oShowNumber, 
                    10,oSprite.height + 8, oSprite.width-20, 22, 
    ...
    this.setShowNumberInfo = function(iNumExtracted){
        ...
        if(_iWin > 0){
            _oResultText.__refreshTextFont(18);
            _oResultText.refreshText(TEXT_YOU_WIN + " "+_iWin+TEXT_CURRENCY);
        }else{
    ...
    this._ballSpin = function(){
        ...
        if(_iCurBallIndex === (NUM_BALL_SPIN_FRAMES)){
            ...
            this.hide();
        }else if(_iCurBallIndex === NUM_FRAME_SHOWING_NUMBER){

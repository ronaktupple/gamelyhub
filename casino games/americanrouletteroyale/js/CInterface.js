function CInterface(){
    ...
    this._init = function(){
        ...
        _oMsgTitle = new CTLText(s_oStage, 
                    _oDisplayBg.x + 5, _oDisplayBg.y+2 , oSprite.width-17, 48, 
                    16, "center", "#fff", FONT1, 1,
                    0, 0,
        ...
        _oSpinBut.setAlign("right");
        _oSpinBut.addEventListener(ON_MOUSE_UP, this._onSpin, this);
        
        _oBetNeighbors = new CTextButton(350,641,s_oSpriteLibrary.getSprite('but_bg'),TEXT_NEIGHBORS,FONT1,"#fff",16,s_oStage);
        _oBetNeighbors.addEventListener(ON_MOUSE_UP, this._onNeighborsPanel, this);
        
        _oBetFinalsBet = new CTextButton(508,641,s_oSpriteLibrary.getSprite('but_bg'),TEXT_FINALSBET,FONT1,"#fff",16,s_oStage);
    ...
    this.refreshMoney = function(iStartMoney, iMoney){
        _oRollingText = new CRollingTextController(_oMoneyAmountText.getMsg(), null, iStartMoney , parseFloat(iMoney), 1000, EASE_LINEAR,TEXT_CURRENCY);
    };

function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'press_but',loop:false,volume:1, ingamename: 'click'});
    ...
    this._loadImages = function(){
        ...
        s_oSpriteLibrary.addSprite("max_bet","./sprites/max_bet.png");
        ...
        for(var i=1;i<NUM_SYMBOLS+1;i++){
            ...
            s_oSpriteLibrary.addSprite("paytable_symbol_"+i,"./sprites/paytable_symbol_"+i+".png");
        }

function CSlotSettings(oData){
    ...
    this._initSymbolAnims = function(){
        ...
        var oData = {   
                        ...
                        // width, height & registration point of each sprite
                        frames: {width: SYMBOL_ANIM_SIZE, height: SYMBOL_ANIM_SIZE, regX: 3, regY: -1}, 
                        animations: {  static: [0, 1],anim:[1,27] }
        };
        ...
        oData = {   
                        ...
                        // width, height & registration point of each sprite
                        frames: {width: SYMBOL_ANIM_SIZE, height: SYMBOL_ANIM_SIZE, regX: 1, regY: 1}, 
                        animations: {  static: [0, 1],anim:[1,27] }
        };
        ...
        oData = {   
                        ...
                        // width, height & registration point of each sprite
                        frames: {width: SYMBOL_ANIM_SIZE, height: SYMBOL_ANIM_SIZE, regX: 0, regY: 3}, 
                        animations: {  static: [0, 1],anim:[1,27] }
        };
        ...
        oData = {   
                        ...
                        // width, height & registration point of each sprite
                        frames: {width: SYMBOL_ANIM_SIZE, height: SYMBOL_ANIM_SIZE, regX: -2, regY: 0}, 
        ...
        oData = {   
                        ...
                        // width, height & registration point of each sprite
                        frames: {width: SYMBOL_ANIM_SIZE, height: SYMBOL_ANIM_SIZE, regX: -1, regY: 0}, 
                        animations: {  static: [0, 1],anim:[1,29] }
        };
        ...
        oData = {   
                        ...
                        // width, height & registration point of each sprite
                        frames: {width: SYMBOL_ANIM_SIZE, height: SYMBOL_ANIM_SIZE, regX: 0, regY: 0}, 

function CReelColumn(iIndex,iXPos,iYPos,iDelay, oParentContainer){
    var _bUpdate;
    var _bReadyToStop;
    ...
    this._init = function(iIndex,iXPos,iYPos,iDelay, oParentContainer){
        _bUpdate = false;
        _bReadyToStop = false;
    ...
    this._init(iIndex,iXPos,iYPos,iDelay, oParentContainer);

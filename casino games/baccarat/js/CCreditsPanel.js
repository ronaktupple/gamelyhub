function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        _pStartPosExit = {x: CANVAS_WIDTH/2 -234, y: 270};
        _oButExit = new CGfxButton(_pStartPosExit.x, _pStartPosExit.y, oSprite, _oContainer);
        _oButExit.addEventListener(ON_MOUSE_UP, this.unload, this);
        
        _oMsgText = new createjs.Text(TEXT_CREDITS_DEVELOPED,"26px "+FONT_GAME_1, "#ffffff");
        ...
        _oLink = new createjs.Text("www.codethislab.com","24px "+FONT_GAME_1, "#ffffff");

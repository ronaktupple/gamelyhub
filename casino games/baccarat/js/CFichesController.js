function CFichesController(){
	...
	_pFicheStartPos=new CVector2();
        ...
        _oBetAmountBackText =  new CTLText(_oTextAttach, 
                    0, 0, 150, 28, 
                    28, "center", "#000", FONT_GAME_1, 1,
                    0, 0,
                    " ",
                    true, true, false,
                    false );
    ...
    this.reset = function(){
        ...
        _oBetAmountBackText.refreshText("");
    ...
    this.refreshFiches = function(aFiches,iXPos,iYPos){
        ...
        for(var i=0;i<aFiches.length;i++){
                var oNewFiche = new CFiche(iXOffset, iYOffset,aFiches[i].index,FICHES_VALUE[aFiches[i].index],0.85,false, _oFichesAttach);
        ...
        _oBetAmountBackText.setX(iXPos+2);
        _oBetAmountBackText.setY(iYPos + 22);
        _oBetAmountBackText.refreshText(formatValue(_iValue));
    };

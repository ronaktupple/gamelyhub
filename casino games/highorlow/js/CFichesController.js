function CFichesController(iX, iY, oParentContainer){
    ...
    this.refreshFiches = function(aFiches,iXPos,iYPos){
        ...
        for(var i=0;i<aFiches.length;i++){
                var oNewFiche = new CFiche(iXOffset, iYOffset,aFiches[i].index,FICHES_VALUE[aFiches[i].index],false, _oFichesAttach);
    ...
    this._createFichesAmountText = function(iX, iY, iAmount){
        _oBetNumBack = new createjs.Text(TEXT_CURRENCY + " " + iAmount,"24px "+PRIMARY_FONT, "#000000");
        _oBetNumBack.x = iX + 3;
        _oBetNumBack.y = iY + 3;
        ...
        _oBetNum = new createjs.Text(TEXT_CURRENCY + " " + iAmount,"24px "+PRIMARY_FONT, "#ffffff");
        _oBetNum.x = iX;
        _oBetNum.y = iY;
    ...
    this.createFichesPile = function(iAmount){
        ...
        this._createFichesAmountText(0,60, iAmount);

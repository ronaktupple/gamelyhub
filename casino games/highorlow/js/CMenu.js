function CMenu(){
    ...
    this._init = function(){
        ...
        _oButPlay = new CGfxButton((CANVAS_WIDTH/2),CANVAS_HEIGHT -130,oSprite, true,s_oStage);
        ...
        if(SHOW_CREDITS){
            ...
            _oButInfo = new CGfxButton(_pStartPosInfo.x,_pStartPosInfo.y,oSprite,true,s_oStage);

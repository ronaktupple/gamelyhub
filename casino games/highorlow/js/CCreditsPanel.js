function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        _pStartPosExit = {x: CANVAS_WIDTH/2 +320, y: 210};
        _oButExit = new CGfxButton(_pStartPosExit.x, _pStartPosExit.y, oSprite, true,_oContainer);
        _oButExit.addEventListener(ON_MOUSE_UP, this.unload, this);
        
        _oMsgText = new createjs.Text(TEXT_CREDITS_DEVELOPED,"26px "+PRIMARY_FONT, "#ffffff");
        ...
        _oLink = new createjs.Text("WWW.CODETHISLAB.COM","30px "+PRIMARY_FONT, "#ffffff");

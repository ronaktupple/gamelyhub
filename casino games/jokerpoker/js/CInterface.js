function CInterface(iMoney,iBet){
    ...
    this._init = function(iMoney,iBet){
        ...
        if(DISABLE_SOUND_MOBILE === false || s_bMobile === false){
            ...
            _pStartPosFullscreen = {x:_oButExit.getX() - oSprite.width - 10,y:(oSprite.height/2) + 10};
        }
	...
	_oMoneyText = new CTLText(s_oStage, 
        ...
        _oBetOneBut = new CTextButton(1040,720,oSprite,TEXT_BET_ONE,FONT1,"#ffffff",23,0,s_oStage);
        _oBetOneBut.addEventListener(ON_MOUSE_UP, this._onButBetOneRelease, this);
        
        _oBetMaxBut = new CTextButton(1190,720,oSprite,TEXT_MAX_BET,FONT1,"#ffffff",23,0,s_oStage);
        _oBetMaxBut.addEventListener(ON_MOUSE_UP, this._onButBetMaxRelease, this);
        
        _oDealBut = new CTextButton(1340,720,oSprite,TEXT_DEAL,FONT1,"#ffffff",30,0,s_oStage);

function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        _pStartPosExit = {x: CANVAS_WIDTH/2 + 287, y: 240};  
        _oButExit = new CGfxButton(_pStartPosExit.x, _pStartPosExit.y, oSprite, _oContainer);
        _oButExit.addEventListener(ON_MOUSE_UP, this.unload, this);
       
        _oMsgTextOutline = new createjs.Text(TEXT_CREDITS_DEVELOPED, "44px " + FONT1, "#000");
	...
	_oContainer.addChild(_oMsgTextOutline);
        ...
        _oMsgText = new createjs.Text(TEXT_CREDITS_DEVELOPED, "44px " + FONT1, "#fff");
	...
	_oContainer.addChild(_oMsgText);
        ...
        _oLinkOutline = new createjs.Text("www.codethislab.com", "40px " + FONT1, "#000");
	...
	_oLinkOutline.x = CANVAS_WIDTH/2+ 20;
        ...
        _oLink = new createjs.Text("www.codethislab.com", "40px " + FONT1, "#fff");

function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'scratch',loop:false,volume:1, ingamename: 'scratch'});
        s_aSoundsInfo.push({path: './sounds/',filename:'no_win',loop:false,volume:1, ingamename: 'no_win'});
        s_aSoundsInfo.push({path: './sounds/',filename:'particle',loop:false,volume:1, ingamename: 'particle'});
        
        for(var k=0;k<NUM_SYMBOLS;k++){
            s_aSoundsInfo.push({path: './sounds/',filename:'symbol'+k,loop:true,volume:1, ingamename: 'symbol'+k});
        }
    ...
    this._loadImages = function(){
        ...
        s_oSpriteLibrary.addSprite("paytable_portrait","./sprites/paytable_portrait.png");
        s_oSpriteLibrary.addSprite("paytable_landscape","./sprites/paytable_landscape.png");
        s_oSpriteLibrary.addSprite("but_no","./sprites/but_no.png");
        
        for(var k=0;k<NUM_SYMBOLS;k++){
            for(var t=0;t<25;t++){
                s_oSpriteLibrary.addSprite("symbol_"+k+"_"+t,"./sprites/symbol_"+k+"/symbol_"+k+"_"+t+".png");
            }
        }
        
        for(var i=0;i<25;i++){
            s_oSpriteLibrary.addSprite("win_frame_anim_"+i,"./sprites/win_frame_anim/win_frame_anim_"+i+".png");
        }
        
        for(var i=0;i<54;i++){
            s_oSpriteLibrary.addSprite("silver_scratch_"+i,"./sprites/silver_scratch/silver_scratch_"+i+".png");
        }

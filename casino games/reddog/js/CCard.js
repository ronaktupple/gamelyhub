function CCard(iX,iY,oContainer){
    ...
    this.setInfo = function(pStartingPoint,pEndingPoint,szFotogram,iValue,iCountCard){
        _bRemoving=false;
        _iTimeElaps=0;
    ...
    this.changePos = function(pNewPos){
        createjs.Tween.get(_oCardSprite).to({x:pNewPos.x,y:pNewPos.y}, 500).call(function(){_pStartingPoint = pNewPos;});
    };
    ...
    this.getCurPos = function(){
        return {x:_oCardSprite.x,y:_oCardSprite.y};
    };
    ...
    this._updateDealing = function(){
        ...
        if (_iTimeElaps >TIME_CARD_DEALING) {
                ...
                _oCardSprite.rotation = 120 + (iCurPerc*240) / 100;

function CAnimText(iX,iY,oParentContainer){
    ...
    this._init = function(iX,iY){
        ...
        _oText = new CTLText(_oContainer, 
                    5, 5, oSpriteBg.width-10, oSpriteBg.height-10, 
    ...
    this.hide = function(){
        createjs.Tween.get(_oContainer).to({x:_pStartPos.x,y:_pStartPos.y}, 500,createjs.Ease.cubicOut).call(function(){   _oContainer.visible = false;

function CInterface(iMoney){
    ...
    this._init = function(iMoney){
        ...
        if(DISABLE_SOUND_MOBILE === false || s_bMobile === false){
            ...
            _oAudioToggle = new CToggle(_pStartPosAudio.x,_pStartPosAudio.y,s_oSpriteLibrary.getSprite('audio_icon'), s_bAudioActive,true,s_oStage);
        ...
        var oTextProg = new CTLText(s_oStage, 
                    502, 496, 300, 18, 
                    18, "left", "#ffde00", FONT_GAME_1, 1,
                    0, 0,
                    TEXT_PROGRESSIVE,
                    true, true, false,
                    false );
    ...
    this.refreshCredit = function(iMoney){
        _oMoneyText.refreshText(TEXT_MONEY+": "+TEXT_CURRENCY+iMoney.toFixed(3));
    };

...
class Reel{
    ...
    _create() 
    {
        ...
        this.visibleMaxY = this.getWindowPosition(0).y + this.symbolSizeY * 0.6;
        this.visibleMinY = this.getWindowPosition(this.windowsCount - 1).y - this.symbolSizeY * 0.6;
        ...
        shape.beginPath();
        shape.fillRect(this.posX - this.symbolSizeY * 0.6, this.windowPosY + this.symbolSizeY * 0.6,  this.symbolSizeY * 1.2, -this.windowsCount * this.symbolSizeY * 1.2);
    ...
    findWindowsSymbols(spriteName)
    {
        ...
        vSymbols.forEach((s)=>{
            ...
            if(s.sprite.name === spriteName) finded.push(s);
        });
        return found;
    }
...
class WinController
{
    ...
    winSymbolShowOnce(completeCallBack)
    {
        ...
        if (this.useScatter && this.scatterWinSymbols != null && this.scatterWinSymbols.length > 0)
        {
            ...
            this.scatterWinSymbols.forEach(()=>{

                pAs.add((callBack) =>
                {
                    item.showWinPrefab();
                    new SimpleTweenFloat(this, 0, 1, 3000, callBack); // just delay action
                });
            });

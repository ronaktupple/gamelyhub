// 3x1 1 line yellow slot 
var slotConfigYellow3x1 = {
    ...
    sprites: [
        ...
        {
            fileName: 'yellow/ButtonBetBig.png',
            name: 'button_bet'
        },
        {
            fileName: 'yellow/ButtonBetBigHover.png',
    ...
    createInfoPUHandler: function(popup)
    {
        ...
        let panel = popup.scene.add.sprite(0, offsetY, 'info_panel').setOrigin(0.5);
        popup.add(panel);

function CInterface(iCurBet,iTotBet,iMoney){
    ...
    this._init = function(iCurBet,iTotBet,iMoney){
        ...
        if(DISABLE_SOUND_MOBILE === false || s_bMobile === false){
            ...
            _pStartPosAudio = {x: _oButExit.getX() - oSpriteAudio.width/2, y: (oSpriteAudio.height/2) + 10};  
        ...
        _oNumLinesText = new CTLText(s_oStage, 
                    494, CANVAS_HEIGHT - 80, oSprite.width, 26, 
        ...
        _oBetCoinBut.addEventListener(ON_MOUSE_UP, this._onBet, this);
         ...
         _oCoinText = new CTLText(s_oStage, 
                    680, CANVAS_HEIGHT - 80, oSprite.width, 26, 
                    26, "center", "#ffffff", FONT_GAME, 1,
                    0, 0,
                    iCurBet.toFixed(2),
                    true, true, false,
        ...
        _oTotalBetText = new CTLText(s_oStage, 
                    866, CANVAS_HEIGHT - 80, oSprite.width, 26, 
                    26, "center", "#ffffff", FONT_GAME, 1,
                    0, 0,
	...
	_oMoneyText = new createjs.Text(TEXT_MONEY +"\n"+iMoney.toFixed(2)+ TEXT_CURRENCY,"30px "+FONT_GAME, "#f951aa");
        ...
        */
        ...
        //LINE 4
        oBut = new CBetBut( 334 + oSprite.width/2, 114 + oSprite.height/2,oSprite,true);
        oBut.addEventListenerWithParams(ON_MOUSE_UP, this._onBetLineClicked, this,4);
        _aLinesBut[3] = oBut;

        //LINE 5
        oBut = new CBetBut( 334 + oSprite.width/2, 502 + oSprite.height/2,oSprite,true);

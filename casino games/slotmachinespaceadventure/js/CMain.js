function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'choose_ufo',loop:false,volume:1, ingamename: 'choose_ufo'});
        s_aSoundsInfo.push({path: './sounds/',filename:'press_hold',loop:false,volume:1, ingamename: 'press_hold'});
        s_aSoundsInfo.push({path: './sounds/',filename:'reveal_alien',loop:false,volume:1, ingamename: 'reveal_alien'});

function CRechargePanel(){
    ...
    this._init = function(){
        ...
        _oMsgTextOutline = new CTLText(_oContainer, 
                    CANVAS_WIDTH/2-240, 230, 480, 150, 
        ...
        _oButExit = new CTextButton(CANVAS_WIDTH/2 - 150,CANVAS_HEIGHT/2 + 100,s_oSpriteLibrary.getSprite("info_but"),TEXT_EXIT,FONT_GAME,"#fff",40,_oContainer);

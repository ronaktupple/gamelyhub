function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'choose_chicken',loop:false,volume:1, ingamename: 'choose_chicken'});
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'reveal_egg',loop:false,volume:1, ingamename: 'reveal_egg'});

function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'bonus_item_choosen',loop:false,volume:1, ingamename: 'bonus_item_choosen'});
        s_aSoundsInfo.push({path: './sounds/',filename:'start_reel',loop:false,volume:1, ingamename: 'start_reel'});
        s_aSoundsInfo.push({path: './sounds/',filename:'reveal_prize',loop:false,volume:1, ingamename: 'reveal_prize'});
        s_aSoundsInfo.push({path: './sounds/',filename:'press_hold',loop:false,volume:1, ingamename: 'press_hold'});
        s_aSoundsInfo.push({path: './sounds/',filename:'soundtrack_bonus',loop:true,volume:1, ingamename: 'soundtrack_bonus'});

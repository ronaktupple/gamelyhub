function CGame(oData){
    ...
    this._initHitAreaColumn = function(){
        ...
        for(var i=0;i<NUM_REELS;i++){
             var oText = new CTLText(s_oStage, 
                    iX, iY + oSprite.height - 20, oSprite.width, 22, 
                    22, "center", "#fff", FONT_GAME, 1,
                    0, 0,
                    " ",
                    true, true, false,
                    false);
    ...
    this._checkForCombos = function(){
        ...
        return _iTotWin*_iCurBet>_iTotBet?true:false;
    };
    ...
    this.changeCoinBet = function(){
        ...
        if(iNewBet>MAX_BET){
            ...
            iNewTotalBet = Math.floor(iNewTotalBet * 100)/100;
    ...
    this._onHitAreaCol = function(oParam){
        ...
        if(_aIndexColumnHold[iIndexCol] === true){
            ...
            _aHoldText[iIndexCol].refreshText(TEXT_HOLD);

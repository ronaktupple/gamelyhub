function CInterface(iCurBet,iTotBet,iMoney){
    ...
    this._init = function(iCurBet,iTotBet,iMoney){
        ...
        if(DISABLE_SOUND_MOBILE === false || s_bMobile === false){
            ...
            _pStartPosAudio = {x: _oButExit.getX() - oSprite.width/2, y: (oSprite.height/2) + 10};  
	...
	_oMoneyText = new CTLText(s_oStage, 
        ...
        //LINE 1
        var oBut = new CBetBut( 328 + oSprite.width/2, 276 + oSprite.height/2,oSprite,true);
        oBut.addEventListenerWithParams(ON_MOUSE_UP, this._onBetLineClicked, this,1);
        _aLinesBut[0] = oBut;
        
        //LINE 2
        oBut = new CBetBut( 326 + oSprite.width/2, 176 + oSprite.height/2,oSprite,true);
        oBut.addEventListenerWithParams(ON_MOUSE_UP, this._onBetLineClicked, this,2);
        _aLinesBut[1] = oBut;
        
        //LINE 3
        oBut = new CBetBut( 326 + oSprite.width/2, 426 + oSprite.height/2,oSprite,true);
        oBut.addEventListenerWithParams(ON_MOUSE_UP, this._onBetLineClicked, this,3);
        _aLinesBut[2] = oBut;
        
        //LINE 4
        oBut = new CBetBut( 326 + oSprite.width/2, 106 + oSprite.height/2,oSprite,true);
        oBut.addEventListenerWithParams(ON_MOUSE_UP, this._onBetLineClicked, this,4);
        _aLinesBut[3] = oBut;

        //LINE 5
        oBut = new CBetBut( 326 + oSprite.width/2, 495 + oSprite.height/2,oSprite,true);

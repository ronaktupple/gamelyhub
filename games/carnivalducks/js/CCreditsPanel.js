function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        _oLink = new createjs.Text("WWW.CODETHISLAB.COM", "22px " + PRIMARY_FONT, "#cc0000");
        _oLinkOutline = new createjs.Text("WWW.CODETHISLAB.COM", "22px " + PRIMARY_FONT, "black");
 _oLinkOutline.textAlign = "center";
        _oLinkOutline.textBaseline = "alphabetic";
        _oLinkOutline.x = CANVAS_WIDTH/2;
        _oLinkOutline.y = CANVAS_HEIGHT/2 + 200;
        ...
        _oLink.y = CANVAS_HEIGHT/2 + 200;
        _oContainer.addChild(_oLink);
        
       
	new createjs.Tween.get(_oContainer).to({y:0},1000, createjs.Ease.quintOut);	
    };
